...
const Courses: React.FC = () => {
  ...
  const isPlanner = user?.global_role === 'PLANNER';
      ...
      <div className="max-w-7xl mx-auto">
        <header className="flex justify-between items-center mb-8 border-b border-slate-900 pb-4">
          ...
          <div className="flex gap-3">
            ...
            <button
              onClick={() => {
                if (user?.global_role === 'PLANNER') navigate('/home');
                else if (user?.global_role === 'ADMIN' || user?.global_role === 'MANAGER') navigate('/portfolio');
